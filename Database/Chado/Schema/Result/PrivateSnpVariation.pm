use utf8;
package Database::Chado::Schema::Result::PrivateSnpVariation;
...
=head1 TABLE: C<private_snp_variation>

=cut

__PACKAGE__->table("private_snp_variation");
...
=head2 C<private_snp_variation_c1>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:llGh5uUkdWpPgGz+bPkeqQ
