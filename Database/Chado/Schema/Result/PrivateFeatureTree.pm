use utf8;
package Database::Chado::Schema::Result::PrivateFeatureTree;
...
Maps private features to the trees structures. When tree_relationship_type is locus
...
=head1 TABLE: C<private_feature_tree>

=cut

__PACKAGE__->table("private_feature_tree");
...
=head2 feature_tree_id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'private_feature_tree_feature_tree_id_seq'
...
=head2 C<private_feature_tree_c1>
...
__PACKAGE__->add_unique_constraint("private_feature_tree_c1", ["feature_id", "tree_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:EbvuQkjfKumwDJaNsRKiYQ
