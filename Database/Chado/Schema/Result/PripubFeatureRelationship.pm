use utf8;
package Database::Chado::Schema::Result::PripubFeatureRelationship;
...
=head1 TABLE: C<pripub_feature_relationship>

=cut

__PACKAGE__->table("pripub_feature_relationship");
...
=head2 feature_relationship_id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'pripub_feature_relationship_feature_relationship_id_seq'
...
=head2 C<pripub_feature_relationship_c1>
...
__PACKAGE__->add_unique_constraint(
  "pripub_feature_relationship_c1",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pPP6U32K5v6PInIPB08Qlg
