use utf8;
package Database::Chado::Schema::Result::AmrCategory;
...
Database::Chado::Schema::Result::AmrCategory - Table that maps AMR category type_ids to gene feature_ids
...
=head1 TABLE: C<amr_category>

=cut

__PACKAGE__->table("amr_category");
...
=item * L</amr_category_id>

=back

=cut

__PACKAGE__->set_primary_key("amr_category_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:R4lmjcZgpj26cC+K2uJnGg
