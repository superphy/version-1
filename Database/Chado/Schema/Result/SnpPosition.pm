use utf8;
package Database::Chado::Schema::Result::SnpPosition;
...
=head1 TABLE: C<snp_position>

=cut

__PACKAGE__->table("snp_position");
...
=head2 snp_position_id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'snp_position_snp_position_id_seq'
...
__PACKAGE__->add_unique_constraint("snp_position_c2", ["locus_id", "region_start", "region_end"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GJVN0xlm+cFLmKrTsYO0PA
