use utf8;
package Database::Chado::Schema::Result::GapPosition;
...
=head1 TABLE: C<gap_position>

=cut

__PACKAGE__->table("gap_position");
...
=head2 gap_position_id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'gap_position_gap_position_id_seq'
...
__PACKAGE__->add_unique_constraint("gap_position_c1", ["snp_id", "contig_collection_id"]);

=head2 C<gap_position_c2>
...
__PACKAGE__->add_unique_constraint("gap_position_c2", ["snp_id", "locus_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6Lne9qGOftz+YqlGrWIHLA
