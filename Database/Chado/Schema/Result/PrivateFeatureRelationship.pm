use utf8;
package Database::Chado::Schema::Result::PrivateFeatureRelationship;
...
=head1 TABLE: C<private_feature_relationship>

=cut

__PACKAGE__->table("private_feature_relationship");
...
=head2 feature_relationship_id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'private_feature_relationship_feature_relationship_id_seq'
...
=head2 C<private_feature_relationship_c1>
...
__PACKAGE__->add_unique_constraint(
  "private_feature_relationship_c1",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:anI4/vSvn5R9nGUPnv7hiQ
