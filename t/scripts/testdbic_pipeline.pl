...
Build a current t/etc/pipeline.pl config file for use in Test::DBIx::Class testing.

Retrieves current data from the PostgresDB to use in the test database.
...
Matt Whiteside (matthew.whiteside@phac-aspc.gc.gc)
...
# DBIx::Class file
my $dbic_file = "$FindBin::Bin/../etc/pipeline.pl";
...
my @tables = qw/Tracker PipelineCache PipelineStatus PendingUpdate/;
