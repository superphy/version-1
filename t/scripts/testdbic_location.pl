...
Build a current t/etc/location.pl config file for use in Test::DBIx::Class testing.
...
# DBIx::Class file
my $dbic_file = "$FindBin::Bin/../etc/location.pl";
