...
(function() {
  ...
  MsaView = (function(superClass) {
    ...
    MsaView.prototype._formatAlignment = function(alignmentJSON) {
      var g, j, len, len1, n, pos, posElem, q, ref, ref1, ref2, ref3, s, seq, seqLen, w;
    ...
    MsaView.prototype._appendRows = function(el, genomes) {
      var a, consArray, g, genomeElem, genomeID, i, j, len, len1, matches, n, name, nameCell, q, ref, ref1, row, rows, s, thiscls, tmp, visibleRows, w;
      genomeElem = {};
      visibleRows = [];
      tmp = {};
      ref = this.rowIDs;
