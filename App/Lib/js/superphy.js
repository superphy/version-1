...
(function() {
  ...
  UserGroups = (function() {
    ...
    UserGroups.prototype._processGroups = function(uGpObj) {
      var $selectized_custom_group_select, custom_groups_select_optgroups, custom_groups_select_options, group, group_collection, group_collection_index, len, len1, q, ref, ref1, ref2, s;
      if (this.username === "") {
        return;
      }
