...
(function() {
  ...
  ViewController = (function() {
    ...
    ViewController.prototype.filterViews = function(filterForm) {
      var len, len1, q, ref, ref1, s, searchTerms, t, term, v;
  ...
  MapView = (function(superClass) {
    ...
    MapView.prototype.update = function(genomes) {
      var aa, divElem, ft, i, len, len1, len2, len3, mapManifest, pubVis, pvtVis, q, ref, ref1, ref2, ref3, s, t1, t2, tableElem, unknownsOff, w;
  ...
  SummaryView = (function(superClass) {
    ...
    SummaryView.prototype.updateActiveGroup = function(usrGrp) {
      var g, len, len1, len2, m, q, ref, ref1, ref2, s, w;
      ref = this.mtypesDisplayed;
      for (q = 0, len = ref.length; q < len; q++) {
        m = ref[q];
    ...
    SummaryView.prototype.groupEditForm = function(buttonsID, usrGrp) {
      ...
      if (usrGrp.username === "") {
        ...
        if (group_delete_button != null) {
          group_delete_button.click((function(_this) {
            return function(e) {
              var g, len, len1, q, ref, s, selection, v;
              e.preventDefault();
              if (buttonsID === '#selection-buttons') {
                _this.clearSelection = true;
                selection = [];
  ...
  UserGroups = (function() {
    ...
    UserGroups.prototype._processGroups = function(uGpObj) {
      var $selectized_custom_group_select, $selectized_standard_group_select, custom_groups_select_optgroups, custom_groups_select_options, group, group_collection, group_collection_index, len, len1, len2, q, ref, ref1, ref2, ref3, ref4, s, standard_groups_select_optgroups, standard_groups_select_options, w;
