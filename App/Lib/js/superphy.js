...
(function() {
  ...
  ViewController = (function() {
    function ViewController() {
      if (typeof jQuery === "undefined" || jQuery === null) {
        throw new SuperphyError('jQuery must be loaded before the SuperPhy library');
      }
    ...
    ViewController.prototype.createView = function() {
      var clickStyle, downloadElem, downloadElemDiv, e, elem, error1, listView, mapView, matView, msaView, sumView, tableView, treeView, vNum, viewArgs, viewType;
        ...
        if (viewType === 'list') {
          ...
          $(window).resize((function(_this) {
            return function(e) {
              ...
              return window.viewController.views[window.viewController.summaryViewIndex].resizing = false;
            };
          })(this));
  ...
  TreeView = (function(superClass) {
    ...
    TreeView.prototype._syncNode = function(node, genomes, sumLengths) {
      var c, child, children, g, isExpanded, ld, len, q, ref, u;
      ...
      if ((node.leaf != null) && node.leaf === "true") {
        ...
        for (q = 0, len = children.length; q < len; q++) {
          ...
          if (!(this.genomes.filtered > 0 || this.genomes.filterReset === true)) {
            record['num_selected'] += r['num_selected'];
          }
          ...
          for (m in ref1) {
            vobj = ref1[m];
            if (record.metaCount[m] == null) {
              record.metaCount[m] = {};
            }
            for (v in vobj) {
              num = vobj[v];
              if (record.metaCount[m][v] != null) {
  ...
  SummaryView = (function(superClass) {
    ...
    function SummaryView(parentElem, style1, elNum, genomes1, summaryArgs) {
      ...
      this.svgSelection = d3.select('#selection-svg').append('svg').attr('class', 'summaryPanel').attr('width', '101%').attr('height', this.height);
      this.svgActiveGroup = d3.select('#active-group-svg').append('svg').attr('class', 'summaryPanel').attr('width', '101%').attr('height', this.height);
    ...
    SummaryView.prototype.updateActiveGroup = function(usrGrp) {
      ...
      if (this.resizing === false) {
        ...
        if (this.selection.length === 0 && this.resizing === false) {
          this.genomeCounter = 'No genomes selected';
        ...
        if (this.activeGroup.length === 0 && this.resizing === false) {
          this.groupTracker = 'No group selected';
    ...
    SummaryView.prototype.createMeters = function(sumCount, svgView, countType) {
      ...
      if ($('#tabs').find('.active').find('a').attr('href') === '#selection-tab') {
        this.width = $('#selection-svg').width() - 150;
      } else if ($('#tabs').find('.active').find('a').attr('href') === '#active-group-tab') {
        this.width = $('#active-group-svg').width() - 150;
      }
      if (countType != null) {
