...
(function() {
  ...
  appendHeader = function(d) {
    var i, j, len, sortIcon, table, v, values;
    table = '<thead><tr>';
    values = [];
    i = -1;
    if (d.sortField === 'name') {
  ...
  root.appendCategories = function(d) {
    var cTitle, categoryE, col2, def, id, introDiv, k, moreInfo, moreInfoId, name, o, ref, ref1, resetButt, row1, row2, s, sel, t, titleDiv;
  ...
  root.filterByCategory = function(catId, subcatId, d) {
    ...
    for (j = 0, len = geneIds.length; j < len; j++) {
      g = geneIds[j];
      o = d.genes[g];
      if (o == null) {
  ...
  root.addSelectedGenes = function(geneIds, d) {
    var actionEl, cls, g, gObj, j, len, listEl;
  ...
  root.selectAllGenes = function(checked, d) {
    var all, g, j, k, l, len, len1, visible;
    if (checked) {
      visible = (function() {
        var ref, results;
        ref = d.genes;
