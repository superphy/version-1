...
var config, exec, exerr, file, fs, introFiles, outJS, spawn, specFiles, strFiles, _ref;
...
task('intro', 'compile intro coffeescript files', function() {
  return exec("coffee -o " + config.outDir + " -c " + introFiles, exerr);
});
