...
\begin{backmatter}
 ...
 \textbf{Project name:} Superphy  
\textbf{Project home page:} https://lfz.corefacility.ca/superphy
\textbf{Operating system(s):} Platform independent (modern web-browser; the most recent Firefox or Chrome for best experience)
\textbf{Programming languages:} Perl, Coffeescript / Javascript, R
\textbf{License:} Apache2

\section*{List of abbreviations}
\textbf{WGS:} whole-genome sequencing
\textbf{DNA:} deoxyribonucleic acid
\textbf{GMOD:} generic model organism database
\textbf{Stx:} Shiga-toxin
\textbf{AMR:} anti-microbial resistance
\textbf{CARD:} comprehensive antibiotic resistance database
\text{SNP:} single-nucleotide polymorphism

\section*{Availability of supporting data}
The project is entirely open source under the Apache 2 license \url{https://www.apache.org/licenses/LICENSE-2.0}. All code and any additional files referenced in the manuscript are available at the GitHub repository \url{https://github.com/superphy/version-1}.
