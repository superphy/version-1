...
\newpage
\begin{table}[h!]
\caption{The number of `conserved core' genomic regions present in  19 selected bacterial genomes.}
...
\newpage
\begin{table}[h!]
\caption{The ten \textit{E. coli} species-specific genomic regions identified in this study, their location in the K12 reference genome MG1655, and their putative function based on the top scoring BlastX hit.}
